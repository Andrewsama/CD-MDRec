...
if __name__ == "__main__":
    ...
    parser.add_argument('--ddi_rate', type=float, default=0.1, help='ddi_rate')
    ...
    parser.add_argument('--gamma', type=float, default=0.01, help='hyperparameter for diffusion loss')
    parser.add_argument('--heads', type=int, default=2, help='the number of multi-head')
    ...
    parser.add_argument('--dataset_path', type=str, default="data/mimic-iv", help='The dataset file path, which should contain the main csv files')
    ...
    parser.add_argument('--seed', type=int, default=1053927574, help='random seed')
    ...
    trainer = Trainer(
        ...
        device=args.device,
        seed=seed,
        info=[str(args.steps), str(args.ddi_rate), str(args.alpha), str(args.beta), str(args.gamma), str(args.heads),
              str(args.num_layers), str(args.embedding_dim), str(args.samp_step), str(args.epochs), str(args.lr)],
    )
