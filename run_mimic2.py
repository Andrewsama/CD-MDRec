...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default="data/mimic-ii", help='The dataset file path, which should contain the main csv files')
    ...
    parser.add_argument('--seed', type=bool, default=468617995, help='random seed')
